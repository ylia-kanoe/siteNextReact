    ...
    return (
        <>
            <header className="bg-teal-500 text-white">
                <div className="flex justify-between items-center max-w-[1200px] m-auto py-[10px]">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="50px" height="50px" viewBox="0 0 1280.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
